{{-- <footer  style="margin-top: 8rem">
    <div class="container-fluid bg-dark text-center text-white p-2">
        Copyright &copy; E-STORE 2023
    </div>
</footer> --}}

<div>
    <div class="footer-area" style="margin-top: 8rem">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">My Store</h4>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2022 - My Store - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
